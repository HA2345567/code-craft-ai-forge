        ...
        <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'ml-0'} overflow-auto`}>
          <main className="min-h-[calc(100vh-4rem)] p-4 md:p-6">
            <div className="relative z-10 container mx-auto">
              <div className="absolute inset-0 bg-gradient-to-b from-primary/5 to-background/10 rounded-3xl blur-3xl -z-10"></div>
              <div className="relative backdrop-blur-sm bg-card/30 rounded-3xl border border-white/10 shadow-lg p-6">
                <Outlet />
              </div>
            </div>
          </main>
